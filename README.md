# Donar-choose-application
Its an ML problem which reads all the application received for donation and using ML model predicts wheather donation will be given or not
